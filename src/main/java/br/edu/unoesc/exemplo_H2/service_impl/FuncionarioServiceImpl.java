...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		repositorio.saveAll(List.of(
				new Funcionario(null, "Maycon", 1, new BigDecimal(1500), LocalDate.now()),
				new Funcionario(null, "Ari", 1, new BigDecimal(1200), LocalDate.now()),
				new Funcionario(null, "Roberto", 1, new BigDecimal(1300), LocalDate.now()),
				new Funcionario(null, "Sicrano", 1, new BigDecimal(800), LocalDate.now()),
				new Funcionario(null, "Matheus", 1, new BigDecimal(3000), LocalDate.now()),
				new Funcionario(null, "Henrique", 1, new BigDecimal(1200), LocalDate.now()),
				new Funcionario(null, "Edilson", 1, new BigDecimal(3500), LocalDate.now())
			)
		);
		
		Funcionario l = new Funcionario(null, "Juliano", 1, new BigDecimal(4080), LocalDate.now());
